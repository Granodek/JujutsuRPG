                ...
                {stat === 'hp'?(<div>
                  <input 
                    ...
                    onChange={(e) => setNumero(Number(e.target.value))} 
                     />    
                  <button onClick={() => handleInputChange(stat, character.stats[stat] -  Math.max(0,(numero -((character.maxStats['stamina']*10)/2) )))} type='submit'>Dano</button>
                ...
                {stat === 'DarkHp'?(<div>
                  <input 
                    ...
                    onChange={(e) => setdarkNumero(Number(e.target.value))} 
                     />    
                  <button onClick={() => handleInputChange(stat, character.stats[stat] -  Math.max(0,(darknumero -((character.maxStats['stamina']*10)/2) )))} type='submit'>Dano</button>
                  <button className='px-2'>ou</button>
