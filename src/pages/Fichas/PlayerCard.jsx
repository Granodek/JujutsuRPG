                ...
                {stat === 'hp'?(<div>
                  <input 
                    ...
                    onChange={(e) => setNumero(Number(e.target.value))} 
                     />    
                  <button onClick={() => handleInputChange(stat, character.stats[stat] - numero)} type='submit'>Calcular</button>
                  </div>) : <div></div> 
                }
                {stat === 'energy'?(<div>
                  <input 
                ...
                {stat === 'DarkHp'?(<div>
                  <input 
                    ...
                    onChange={(e) => setdarkNumero(Number(e.target.value))} 
                     />    
                  <button onClick={() => handleInputChange(stat, character.stats[stat] - darknumero)} type='submit'>Calcular</button>
                  </div>) : <div></div> 
                }
                {stat === 'energy'?(<div>
                  <input 
