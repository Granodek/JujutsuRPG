                ...
                {stat === 'DarkHp'?(<div>
                  <input 
                    ...
                    onChange={(e) => setdarkNumero(Number(e.target.value))} 
                     />    
                  <button onClick={() => handleInputChange(stat, character.stats[stat] -  Math.round(Math.max(0,(darknumero -((character.maxStats['stamina']*10)/2) - (character.stats['energy']/10) ))))} type='submit'>Dano</button>
                  <button className='px-2'>ou</button>
