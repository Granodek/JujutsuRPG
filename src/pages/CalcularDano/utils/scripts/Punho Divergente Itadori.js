function punhoDivergenteItadori(dice, defense, accuracy, technique, strength, mastery, setNewValueHit, setValuesHit) {   
    ...
    if (dice === 1) {
        ...
        return `Black Flash Dano 300%: ${dano.toFixed(0)}`;
...
export default punhoDivergenteItadori;