...
import bgVortex from "../../assets/um vortex tipo uma fenda imensional preta.png"

const DamageInputs = () => {
    const { handleCalculateDamage, setNewValueHit, getColorHit, colorHit, valueDice, valuesHit, calculatedDamage, currentAccuracy, handleAccuracyChange, currentStrength, handleStrengthChange, currentTechnique, handleTechniqueChange, currentMastery, handleMasteryChange } = useContext(DamageContext);
    return (
