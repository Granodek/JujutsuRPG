...
const DamageInputs = () => {
    const {
      handleCalculateDamage, setNewValueHit, getColorHit, colorHit, valueDice,
      valuesHit, calculatedDamage, currentAccuracy, handleAccuracyChange,
      currentStrength, handleStrengthChange, currentTechnique, handleTechniqueChange,
      currentMastery, handleMasteryChange, currentDefense, handleDefenseChange
