...
const MainDamageCalculator = () => {
  ...
  const getColor = (valueDice, valuesHit) => {
    ...
    const handleCalculateDamage = () => {
      const damage = currentScript.calculateDamage(valueDice, currentAccuracy, currentTechnique, currentStrength, currentMastery, setNewValueHit)
